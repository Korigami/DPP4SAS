...
%hermite_sampler_full(result_eigvals = herm_vals, size=1000, beta=4, normalize=1, random_state=124);

proc univariate data= herm_vals;
    var col1;
    histogram col1;
run;
...
%mu_ref_normal_sampler_tridiag(result_eigvals = mu_vals, loc=10.0, scale=10.0, beta=4, size=1000, normalize=1, random_state=124);


proc univariate data= mu_vals;
    var col1;
    histogram col1;
run;
...
%put %marcenko_pasteur_law(0.5, 10, 5, sigma=1.5);
...
%laguerre_sampler_full(result_eigvals = eig_vals, M=2400, N=2000, beta=2, normalize=1,  random_state=1);

proc univariate data=eig_vals;
    var col1;
    histogram col1;
run;
...
%laguerre_sampler_full(result_eigvals=lag_vals1, M=1500, N=500, beta=1, random_state=10);

proc univariate data= lag_vals1;
    histogram col1;
run;

%laguerre_sampler_full(result_eigvals=lag_vals2, M=1500, N=500, beta=2, random_state=10);

proc univariate data= lag_vals2;
    histogram col1;
run;

%laguerre_sampler_full(result_eigvals=lag_vals4, M=1500, N=500, beta=4, random_state=10);

proc univariate data= lag_vals4;
    histogram col1;
run;
...
%mu_ref_gamma_sampler_tridiag(result_eigvals = gamma_vals, shape=6000, scale=2.0, beta=2.98, size=4000, normalize=1, random_state=135);


proc univariate data= gamma_vals;
    var col1;
    histogram col1;
run;
...
%jacobi_sampler_full(result_eigvals=jac_vals, M_1=150, M_2=100, N=50, beta=4, random_state=10);

proc univariate data= jac_vals;
    histogram col1;
run;


%jacobi_sampler_full(result_eigvals=jac_vals1, M_1=1500, M_2=1000, N=500, beta=1, random_state=10);

proc univariate data= jac_vals1;
    histogram col1;
run;

%jacobi_sampler_full(result_eigvals=jac_vals2, M_1=1500, M_2=1000, N=500, beta=2, random_state=10);

proc univariate data= jac_vals2;
    histogram col1;
run;

%jacobi_sampler_full(result_eigvals=jac_vals4, M_1=1500, M_2=1000, N=500, beta=4, random_state=10);

proc univariate data= jac_vals4;
    histogram col1;
run;
...
%put %wachter_law(x=0.25, M_1=200, M_2=150, N=100);
...
%mu_ref_beta_sampler_tridiag(result_eigvals = beta_vals, a = 5000, b = 3000, beta=3.14, size=4000, random_state=156);

proc univariate data= beta_vals;
    histogram col1;
run;
...
%circular_sampler_full(result_eigvals=cir_vals, N=10, beta=4, haar_mode="Hermite", heurestic_fix=0, random_state=1618);


PROC sgscatter  DATA = cir_vals;
   PLOT Col2 * Col1;
RUN;

%circular_sampler_full(result_eigvals=cir_vals, N=10, beta=4, haar_mode="Hermite", heurestic_fix=1, random_state=1618);
...
%mu_ref_unif_unit_circle_sampler(result_eigvals = cir_vals, beta=10, size=10, normalize=1, random_state=1618);

PROC sgscatter  DATA = cir_vals;
   PLOT Col2 * Col1;
RUN;

%mu_ref_unif_unit_circle_sampler(result_eigvals = cir_vals, beta=20, size=10, random_state=1234);

PROC sgscatter  DATA = cir_vals;
   PLOT Col2 * Col1;
RUN;

%mu_ref_unif_unit_circle_sampler(result_eigvals = cir_vals, beta=40, size=10, random_state=1234);

PROC sgscatter  DATA = cir_vals;
   PLOT Col2 * Col1;
RUN;

%mu_ref_unif_unit_circle_sampler(result_eigvals = cir_vals, beta=80, size=10, random_state=1234);
...
%macro ginibre_sampler_full(result_eigvals, N, normalize=1, random_state=1618);
...
%ginibre_sampler_full(result_eigvals=gini, N=1000, normalize=1, random_state=135);

PROC sgscatter  DATA = gini;
   PLOT col1*col2; 
RUN; 
