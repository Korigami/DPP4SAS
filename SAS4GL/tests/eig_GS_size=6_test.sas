...
%proj_dpp_sampler_eig_GS(evec2, dest = res1, size = 6, random_state = 1)
%proj_dpp_sampler_eig_GS(evec2, dest = res2, size = 6, random_state = 11342)
%proj_dpp_sampler_eig_GS(evec2, dest = res3, size = 6, random_state = 1512)
%proj_dpp_sampler_eig_GS(evec2, dest = res4, size = 6, random_state = 4651)
%proj_dpp_sampler_eig_GS(evec2, dest = res5, size = 6, random_state = 1543)
%proj_dpp_sampler_eig_GS(evec2, dest = res6, size = 6, random_state = 134)
%proj_dpp_sampler_eig_GS(evec2, dest = res7, size = 6, random_state = 1132)
%proj_dpp_sampler_eig_GS(evec2, dest = res8, size = 6, random_state = 1543)
%proj_dpp_sampler_eig_GS(evec2, dest = res9, size = 6, random_state = 1123)
%proj_dpp_sampler_eig_GS(evec2, dest = res10, size = 6, random_state = 21123)
%proj_dpp_sampler_eig_GS(evec2, dest = res11, size = 6, random_state = 2154)
%proj_dpp_sampler_eig_GS(evec2, dest = res12, size = 6, random_state = 211342)
%proj_dpp_sampler_eig_GS(evec2, dest = res13, size = 6, random_state = 21512)
%proj_dpp_sampler_eig_GS(evec2, dest = res14, size = 6, random_state = 24651)
%proj_dpp_sampler_eig_GS(evec2, dest = res15, size = 6, random_state = 21543)
%proj_dpp_sampler_eig_GS(evec2, dest = res16, size = 6, random_state = 2134)
%proj_dpp_sampler_eig_GS(evec2, dest = res17, size = 6, random_state = 21132)
%proj_dpp_sampler_eig_GS(evec2, dest = res18, size = 6, random_state = 21543)
%proj_dpp_sampler_eig_GS(evec2, dest = res19, size = 6, random_state = 21123)
%proj_dpp_sampler_eig_GS(evec2, dest = res20, size = 6, random_state = 12123)

data full_res_GS_eig_siz;
		set res1 res2 res3 res4 res5 res6 res7 res8 res9 res10 
			res11 res12 res13 res14 res15 res16 res17 res18 res19 res20;
	run;


%get_emp_kernel_from_sample(full_res_GS_eig_siz);
...
%plot_matrix(emp_ker_from_full_res_GS_eig_siz, Empirical Kernel);
/*
