...
%if (%sysfunc(scan(&Y,&i))=0 and %sysfunc(scan(&Y,&i.+1))=1) or (%sysfunc(scan(&Y,&i))=0 and %sysfunc(scan(&Y,&i.+1))=0 and %sysfun     
c(scan(&X,&i.))=1) %then %do;                                                                                                           
...
/*                                                                                                                                      
%sample_poissonized_plancherel(100);                                                                                                    
                                                                                                                                        
%carries_sample(6,size=100);                                                                                                            
                                                                                                                                        
%virtual_descent_sampler(size=10);                                                                                                      
                                                                                                                                        
%descent_sampler(size=50,random_state=123);                                                                                             
                                                                                                                                        
*/                                                                                                                                      
                                                                                                                                        
                                                                                                                                        
%macro stat_1_dep_sampler(size=100, dest, mode='descent', base=., x0=0.5, random_state=.);                                              
...
%if &mode='carries' %then %do;                                                                                                          
        %if &base=. %then %do;                                                                                                          
                %put Base must be provided (integer >0);                                                                                
        %end;                                                                                                                           
        %else %do;                                                                                                                      
...
/*                                                                                                                                      
%stat_1_dep_sampler(mode='descent');                                                                                                    
*/
